...
public interface Restrict {
     ...
     * @return a {@link Reverter} to remove the permission from the component or view, so that it is
     * no longer needed to be granted in order for the component to be visible or the view to be
     * navigable
     ...
     * @return a {@link Reverter} to remove the permissions from the component or view, so that they
     * are no longer needed to be granted in order for the component to be visible or the view to be
     * navigable
     * @see org.ilay.Authorization#start(Set)
     * @see org.ilay.Authorization#start(Supplier)
     */
